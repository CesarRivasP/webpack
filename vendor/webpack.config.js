...
module.exports = {
  mode: 'development',
  entry: {
    vendor: [ //para configurar cuales son los paquetes a colocar dentro del vendor.js
      'react',  //librerias, paquetes de npm instalados que se quieren empaquetar
      'react-dom',
    ],
